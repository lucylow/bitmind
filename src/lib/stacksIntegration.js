 ...
 */
import { standardPrincipalCV, uintCV, callReadOnlyFunction, AnchorMode, PostConditionMode, } from '@stacks/transactions';
 ...
 */
export async function releaseFunds(invoiceId, userSession) {
    const functionArgs = [uintCV(invoiceId)];
    const options = {
        contractAddress: CONTRACT_ADDRESS,
        contractName: ESCROW_CONTRACT,
