...
export class InvoiceController {
    constructor() {
        ...
        Object.defineProperty(this, "stacksService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "ipfsService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "webhookService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "createSmartInvoice", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: async (req, res) => {
                try {
                    ...
                    const { description, clientWallet, contractorAddress, arbitratorAddress, projectTitle, metadata } = req.body;
                    ...
                    const deployment = await this.stacksService.deployInvoiceContract(contractResult.clarity_code, { invoiceId: invoice.id }, process.env.STACKS_DEPLOYER_PRIVATE_KEY);
        ...
        Object.defineProperty(this, "releaseMilestone", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: async (req, res) => {
                try {
                    ...
                    const { invoiceId, milestoneId, clientWallet, proof, signature } = req.body;
                    ...
                    const result = await this.stacksService.releaseMilestone(invoice.contractAddress, invoice.contractAddress.split('.')[1], // contract name
                    milestone.sequence, process.env.STACKS_DEPLOYER_PRIVATE_KEY // In practice, use client's key
                    );
                    if (!result.success) {
        ...
        Object.defineProperty(this, "getInvoiceDetails", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: async (req, res) => {
                try {
                    ...
                    if (invoice.contractAddress) {
                        try {
                            contractState = await this.stacksService.getContractState(invoice.contractAddress.split('.')[0], invoice.contractAddress.split('.')[1]);
                        }
                        catch (error) {
        ...
        Object.defineProperty(this, "listUserInvoices", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: async (req, res) => {
    ...
    calculatePermissions(invoice, walletAddress) {
        const permissions = {
            canRelease: false,
            canApprove: false,
            canDispute: false,
    ...
    async waitForDeploymentConfirmation(invoiceId, transactionId) {
        try {
